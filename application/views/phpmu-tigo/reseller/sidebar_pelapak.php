...
echo "<div class='widget'>
    <h3>Tentang Pelapak</h3>";
      ...
      <tbody>";
        ...
        $pelanggan = $this->db->query("SELECT id_pembeli, COUNT(*) as total_sales FROM rb_penjualan WHERE id_penjual='$rows[id_reseller]' AND status_pembeli='konsumen' AND status_penjual='reseller' GROUP BY id_pembeli");
